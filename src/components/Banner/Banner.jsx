...
const Banner = ({title, bgColor, textColor, image, paragraph, hasHashtag, hashtag, isFlipped, hasButton, buttonText, buttonBorder}) => {
    ...
    return (
        <div className="mb-4">
            <div className={`flex flex-col justify-center items-center ${bgColor} ${isFlipped ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
                    ...
                    <div className={`${textColor} text-center w-full p-12`}>
                        ...
                        }
                        {
                            ...
                            ?   <a className="text-lg font-semibold my-4" href="#">
                                    <button className={`bg-transparent ${textColor} border ${buttonBorder} rounded-full px-4`}>{buttonText}</button>
                                </a>
                            : null
                        }
                    </div>
